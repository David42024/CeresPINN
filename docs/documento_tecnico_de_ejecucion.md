...
| Escenarios | Tres copias del mismo target histórico | No permiten aprender el efecto causal de SSP1 frente a SSP5 |
| Manejo | Sin targets observados | Los efectos actuales de riego variedad o nitrógeno son multiplicadores programados |
| Estados diarios | Sin observaciones de humedad LAI biomasa o CWSI | La serie diaria es una simulación determinista |
| Consumo frontend | Funcional mediante /api/simulate | El contrato exige inference_mode=pinn |
...
| :--- | :--- | :--- |
| Ingesta | Descargar y versionar clima histórico y proyecciones CMIP6 | Archivos crudos inmutables y manifiestos |
...
| Registro | Guardar artefacto esquema normalización y dominio | Paquete versionado de modelo |
| Inferencia | Validar entradas predecir intervalo y detectar extrapolación | Respuesta JSON con procedencia |
| Simulador | Ejecutar balance hídrico y cálculos derivados | Serie diaria identificada como determinista |
| Frontend | Mostrar resultado incertidumbre y limitaciones | Interfaz auditable fuente |
...
| C | Estados diarios y respuesta a manejo aprendida | Gemelo parcelario | Trabajo futuro sujeto a datos y validación |
...
| Bloque | Trabajo | Duración | Dependencia |
| :--- | :--- | :--- | :--- |
| 1 | Línea base | 1 semana | Ninguna |
